...
class Agent:
    ...
    def __init__(self, sensory_space, action_space, learning_rate, discount=0.99):
        ...
        self.optimizer = torch.optim.AdamW(self.A2C_net.parameters(), lr=self.learning_rate, weight_decay=0.01)
    ...
    def train_policy(self):
        ...
        print(torch.tensor(self.A2C_net.values))
...
for j in range(0, 10):
    ...
    np.savetxt("LunarLandar_A2C"+str(j)+".csv", res, delimiter=",")
